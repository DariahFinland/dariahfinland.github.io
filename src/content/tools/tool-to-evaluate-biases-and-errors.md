...
accessLinks:
  - label: End-user interface
    url: https://github.com/hsci-r/elasticsearch-openshift/blob/main/documentation/exported_query.md
  - label: Technical documentation
    url: https://github.com/hsci-r/elasticsearch-openshift
