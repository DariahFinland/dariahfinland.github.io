...
• Participants must install Node.js ([https://nodejs.org/en](https://nodejs.org/en)) on their computer before the start of the workshop  
...
More information: [anna.sendratoset@tuni.fi](mailto:anna.sendratoset@tuni.fi)
