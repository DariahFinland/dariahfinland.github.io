...
meta:
  ...
  description: On the first FIN-CLARIAH plenary this season the whole
    infrastructure reflected on how SSH research will be affected by AI and
    introduced what they will…
...
These challenges have been tackled by several projects, for example to develop textual descriptions for the iconic Finnish Wartime Photograph Archive[2]. This theme guided discussion groups where participants brainstormed ways AI could be implemented at national level in infrastructures to support SSH researchers interested in textual, visual or audiovisual data. 
...
1. For example the [COCO dataset](https://cocodataset.org/#home) is a training dataset with a total of 2.5 million labelled instances (visible image attributes) in 328k images drawing upon extensive crowd worker involvement. For an overview on crowdsourcing both in cultural heritage and digital humanities see [Terras, 2015](http://doi.org/10.1002/9781118680605.ch29) and [Hiippala, 2022](https://aclanthology.org/2022.latechclfl-1.2/)
2. [Tekoäly seuloo sotakuvia EU-direktiiviä varten](https://www.tuni.fi/fi/ajankohtaista/tekoaly-seuloo-sotakuvia-eu-direktiivia-varten) (article here: [doi.org/10.1109/ACCESS.2020.3014458](http://doi.org/10.1109/ACCESS.2020.3014458))
