---
title: FIN-CLARIAH summer meeting builds "Roads to Multimodality"
heroImage: /media/IMG_2015-scaled-e1750835325675.jpg
heroImageAlt: IMG 2015 scaled e1750835325675
authors:
  - Inés Matres
  - Venla Poso
...
meta:
  ...
  description: Before we begin the summer hiatus we bring news from the last
    FIN-CLARIAH day dedicated to building Roads to Multimodality. On June 13,
    the members of the…
  image: /media/IMG_2015-scaled-e1750835325675.jpg
---
Before we begin the summer hiatus we bring news from the last FIN-CLARIAH day dedicated to building *Roads to Multimodality*. On June 13, the members of the national consortium FIN-CLARIAH were hosted by the DARIAH-FI node at the [University of Jyväskylä](https://www.dariah.fi/local-offices/local-office-detail-jyvaskyla/) in the green surroundings of Seminaarimäki. Lynty ("Lantern") was chosen as venue, a building designed by Alvar Aalto on top of the campus hill. This symbolic place was fit to celebrate the news that FIN-CLARIAH has been granted [lighthouse status](https://www.aka.fi/en/about-us/whats-new/press-releases/2025/firi-committee-decides-funding-for-finnish-research-infrastructure-roadmap-selects-lighthouse-infrastructures/), which means that FIN-CLARIAH is one of [six research infrastructures](https://www.aka.fi/globalassets/2-suomen-akatemian-toiminta/5-ajankohtaista/1-tiedotteet-ja-uutiset/2025/lighthouse-research-infrastructures-2025.pdf) selected to lead the way in service provision, impact and shared use. This day in Jyväskylä was dedicated to setting standards in latest and multimodal modes of research. With insights for processing audiovisual data.
...
[Watch lecture by Prof. Erkut Erdem here](https://www.youtube.com/watch?v=ISpswtfQJ0I) (Shared with permission: CC-BY).

One of the goals of FIN-CLARIAH since 2024 has been to create better infrastructures for researchers using social media and multimodal content. Past events have showed us that SSH researchers are interested in both (see reports from [FIN-CLARIAH day in Helsinki](https://www.dariah.fi/2024/06/18/fin-clariah-day-ai-implementation/) or [Roadshow in Vaasa](https://www.dariah.fi/2025/04/27/fin-clariah-roadshow-in-vaasa-some-take-outs/)). It is undeniable that social media is multimodal. This is evident in the "convergence" of platforms such as Instagram, TikTok, YouTube or Twitch, where users upload live-streams and short video clips, or react textually and visually to them. If we look at historical sources, our most recent history has produced an audiovisual heritage that will be available on an ever larger scale. Thus, there is a **wide community of researchers** that can benefit if analysis tools include functionalities such as the **creation of synchronous content descriptions**, or inversely the capacity to **search visual elements or key moments using textual prompts**, also when the material is not annotated or subtitled.
...
In the afternoon Juhana Salonen introduced the Jyväskylä-based [Corpus Project of Finland's Sign Languages (CFINSL → Sign bank)](https://signbank.csc.fi/). This project recorded over hundred interviews documenting Finnish and Finland-Swedish Sign Language. This corpus is now published in [Kielipankki](https://www.kielipankki.fi/) in two datasets: one fully annotated Finnish Sign Language[1](http://urn.fi/urn:nbn:fi:lb-2021092401) corpus, and another non-annotated in Finland-Swedish Sign Language[2](http://urn.fi/urn:nbn:fi:lb-2024090329).

![](/media/salonen-insight-pic1-1-edited.jpg)

*Details from the interviews recorded for the project CFINSL.* 

The CFINSL project required a thorough documentation of each interview, shot with several cameras; and the work of volunteers who transcribed the interviews with [ELAN](https://archive.mpi.nl/tla/elan). In this corpus one can find open-access conversations (see image above, in green) which can be further re-used for teaching sign-language or to develop much needed solutions to aid interpreters; and more restricted-access material (see image above, in yellow) containing personal narratives from the Sign Language community. While this research field has special demands, similar recording and annotating infrastructures are used in oral history or visual anthropology. 
...
Header image: Rosalma

1 Suomalaisen viittomakielen korpus [http://urn.fi/urn:nbn:fi:lb-2021092401](http://urn.fi/urn:nbn:fi:lb-2021092401)

2 Finlandssvensk teckenspråkskorpus [http://urn.fi/urn:nbn:fi:lb-2024090329](http://urn.fi/urn:nbn:fi:lb-2024090329)