...
accessLinks:
  - label: Toxicity classifier
    url: https://github.com/TurkuNLP/toxicity-classifier
  - label: Multilingual modeling of web registers
    url: https://github.com/TurkuNLP/multilingual-register-labeling
