...
meta:
  ...
  description: The makers of FinnSurveyText introduce the resource through a demo
    guide and describe the process of creating an open-source tool for research.
...
![](/media/2_response-numbers-table.png)

![](/media/3_length-table-1024x155.png)

![](/media/4_POS-Table.png)
...
![](/media/8_concept-network-1024x902.png)
...
![](/media/10_comparison-concept-network.png)
