...
startDate: '2025-11-28T10:30:00.000Z'
...
The milestone event is hosted by the [Centre for Social Data Science (CSDS)](https://www.helsinki.fi/en/networks/centre-social-data-science), it supports the broader goals of FIN-CLARIAH in developing national infrastructure for digital humanities and social sciences, and welcomes researchers and students from across disciplines interested in qualitative data, narrative analysis, secure practices for sensitive data, and the responsible use of AI tools in the annotation pipeline.

**When: November 28, 2025 (10:30-17:00)
Where: University of Helsinki , Metsätalo (Unioninkatu 40, 00170 Helsinki). Plenary in SALI 6 (3rd floor/B-wing)Registration for this event closed, contact ines.matres@helsinki.fi if you have questions (lectures in the plenary are open).**
...
1) CSC [AITTA environment](https://staging-aitta.2.rahtiapp.fi/public) to deal with LLMs. Training large language model towards annotating data (Facilitator: Martin Mathiessen, CSC)

2) CSC [Sensitive Data (SD) environment](https://research.csc.fi/sensitive-data/sensitive-data-sd-services-for-research/) and how to use it - hands on session (BYO) (Facilitators: Francesca Morello, Kimmo Mattila, CSC)
